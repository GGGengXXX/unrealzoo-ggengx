...
class TimeDilationWrapper(Wrapper):
    def __init__(self, env, reference_fps=10, update_steps=1, update_dilation=True):
        super().__init__(env)
        self.dilation_factor = 5  # the factor by which to slow down the environment
